...
java  org.opendaylight.fpc.activation.impl.dpdkdpn.DpnCmd2 -method create_session -ip 127.0.0.1 -port 5559 -imsi 12345 -ue_ip 10.0.0.1 -default_ebi 9 -s1u_sgw_gtpu_ipv4 10.0.0.2 -s1u_sgw_gtpu_teid 1234
