...
java org.opendaylight.fpc.activation.impl.dpdkdpn.DpnCmd2 -method create_bearer_dl -ip 127.0.0.1 -port 5559 -imsi 12345 -default_ebi 9 -dedicated_ebi 1 -s1u_sgw_gtpu_teid 991133 -s1u_enb_gtpu_ipv4 10.0.0.9 -s1u_enb_gtpu_teid 889900 -s1u_sgw_gtpu_ipv4 10.0.0.2
