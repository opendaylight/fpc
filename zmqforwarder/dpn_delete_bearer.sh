...
java  org.opendaylight.fpc.activation.impl.dpdkdpn.DpnCmd2 -method delete_bearer -ip 127.0.0.1 -port 5559 -s1u_sgw_gtpu_teid 991133 -s1u_enb_gtpu_ipv4 10.0.0.9 -s1u_enb_gtpu_teid 889900
